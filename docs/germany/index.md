...
Wir hätten unsere Visualisierungen nicht umsetzen können ohne [HyStreet Daten](https://hystreet.com/) und die [HyStreet R-Wrapper](https://cran.r-project.org/web/packages/hystReet/index.html). Vielen Dank! Ein grosses Dankeschön auch an die [OpenStreetMap-Beitragenden](https://www.openstreetmap.org/copyright) für die Kartendaten.
